...
public class Hommes_Poissons extends Marine {
	...
	public void move(Map m) {
		...
		if(nextMove!=null) {
			if(nextMove.getObstacle()!=null && nextMove.getObstacle() instanceof Poneglyphe) {
				...
				System.out.println("Homme-poisson : Poneglyphe " + poneglyphe.getId() + " recup√©r√©.");
			}
	...
	public void attaquer(Case cible) {
		...
		// on cherche les donnÈes sur la cible
		...
		// si on a assez de point d'attaque la cible se voit infligÈ des degats et on perd 1 PA
		}
